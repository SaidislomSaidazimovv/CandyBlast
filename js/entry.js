...
(()=>{
 ...
 function updateProfileButton(){
  ...
  if(homeName)homeName.textContent=name;if(homeStatus)homeStatus.textContent=`Level ${current} · ★ ${stars}/60`;window.CandyProfiles?.mount(avatar,profile?.avatar,{label:false});
 }
