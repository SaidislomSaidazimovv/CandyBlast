...
window.Candy3DBridge={
  ...
  swipe(a,b){if(hammerMode||busy||paused||pregame||gameEnded)return;if(selected){getCell(selected.r,selected.c)?.classList.remove('selected');selected=null;}trySwap(Math.floor(a/8),a%8,Math.floor(b/8),b%8);}
};
